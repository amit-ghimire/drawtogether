        ...
        if (Input.GetMouseButton(0))
        {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                if (pallet != null)
                {
                    ...
                    Debug.Log(BrushSizeSlider.Instance.BrushSize);

                    CmdBrushAreaWithColorOnServer(pixelUV, ColorPicker.SelectedColor, BrushSizeSlider.Instance.BrushSize);
                    BrushAreaWithColor(pixelUV, ColorPicker.SelectedColor, BrushSizeSlider.Instance.BrushSize);
                }
            }
        }
    }
